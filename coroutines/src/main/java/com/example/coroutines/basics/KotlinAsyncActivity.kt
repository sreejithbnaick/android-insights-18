package com.example.coroutines.basics
...
import com.example.coroutines.basics.helpers.load
import com.example.coroutines.basics.helpers.logd
import com.example.coroutines.basics.helpers.then
import kotlinx.android.synthetic.main.activity_kotlin_async.*
import kotlinx.coroutines.experimental.delay

class KotlinAsyncActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kotlin_async)
